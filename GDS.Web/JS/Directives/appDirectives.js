...
//                if (text) {
//                    var findsDot = new RegExp(/^[0-9]+(\.[0-9]{1,4})?$/);
//                    var transformedInput = text.match(findsDot);
//                    if ((transformedInput == null || transformedInput == undefined) && (text.indexOf('.') != text.length - 1)) {
//                        ngModelCtrl.$setViewValue("");
//                        ngModelCtrl.$render();
//                    } else {
//                        if (!isNullOrUndefinedOrEmpty(transformedInput)) {
