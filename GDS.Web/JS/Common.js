...
$(function () {
    ...
    pageScrollToControl = function (controlSelector) {
        if (controlSelector != undefined && controlSelector != null) {

            $('html, body').animate({
                scrollTop: $(controlSelector).offset().top
            }, 500);
...
function BindCustomerSearchBar($scope, $compile, dataTable) {
    var searchBar = '<div class="row searcharea"><div id="customSearch" ><div class="col-sm-12"><label class="control-label" translate="Admin_SearchCriteria">Search Criteria:</label></div>' +
...
//dd MMM, 2016
//function validatedate(inputdateString) {

//    if (inputdateString != undefined && inputdateString != null) {
//        inputdateString = inputdateString.toString();
//        inputdateString = inputdateString.trim();
//    }

//    var re = /^(\d{1,2})(\/|\s)([a-zA-Z]{3})(\/|,\s)(\d{4})$/;
...
//    if (inputdateString != '') {
//        if (re.test(inputdateString)) {
//            // document.form1.text1.focus();
//            //Test which seperator is used '/' or '-'  
//            var opera1 = inputdateString.split(' ');
